                                ...
                                children: [
                                  FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final usersColumnGetUsersResponse =
                                          snapshot.data!;
                                      return Builder(
                                        builder: (context) {
                                          final usersList =
                                              usersColumnGetUsersResponse
                                                  .jsonBody
                                                  .toList();
                                          return Column(
                                            mainAxisSize: MainAxisSize.max,
                                                                    ...
                                                                    return Column(
                                                                      ...
                                                                      children: List.generate(
                                                                          standnamesList
                                                                              .length,
                                                                          (standnamesListIndex) {
                                                                        final standnamesListItem =
                                                                            standnamesList[standnamesListIndex];
                                                                        return Text(
                                                                          standnamesListItem
                                                                              .toString(),
                                                                          style: FlutterFlowTheme.of(context)
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                ...
                                                                controller: _model
                                                                    ...
                                                                    FormFieldController<
                                                                        String>(
                                                                  _model
                                                                      .standDropDownValue ??= (GetStandsCall
                                                                          .standNameListDE(
